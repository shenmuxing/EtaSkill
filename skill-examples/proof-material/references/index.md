# Proof Material Index

This index routes from public sources to source-indexed proof material. It is intentionally source-first; final reusable categories belong in `proof-usage`.

| Source | File | Main domains | Item count | Tags |
| --- | --- | --- | --- | --- |
...
- Use this index when `proof-finder` adds source-level material or when `proof-cooker` needs source context.
- Search material files by stable ID, paper location, candidate tags, and cooker hints.
- Do not add raw extraction logs or source transcripts here.

...
2. Default staleness threshold: **24 hours** (individual skills may override — e.g., `auto-review-loop` uses 24h). If a skill defines its own threshold, that takes precedence.
